...
enum {
    ...
    EXT_WRAM_256KB_MIRROR_END = 0x02FFFFFF,

	INT_WRAM_32KB 		= 0x03000000,
	INT_WRAM_32KB_END  	= 0x03007FFF,
    INT_WRAM_32KB_MIRROR_END = 0x03FFFFFF,
    ...
    PALETTE_RAM_1KB_MIRROR_END = 0x05FFFFFF,

	VRAM_96KB 			= 0x06000000,
	VRAM_96KB_END 		= 0x06017FFF,
    VRAM_96KB_MIRROR_END = 0x06FFFFFF,

	OAM_1KB 			= 0x07000000,
	OAM_1KB_END 		= 0x070003FF,
    OAM_1KB_MIRROR_END  = 0x07FFFFFF,
